...
- [x] **Issue #322**: [TAG: Perf] Implement Progressive Dynamic Imports for ThreeJS Component in Marketing & Demo Slices. [DESC: Resolved esbuild deprecation warnings by pinning @astrojs/react to v6.0.1 (upgrading Vite compile target) and implementing esbuild cleanup pre-plugins, decoupled WebGL dependencies into lazy-loaded ThreeCanvas chunks, and refactored dynamic loading spinners to utility css rules. Verified 🟢 PHAROS GREEN.] [ECT: 3] [ACT: 3]
