...
- [x] **Issue #297**: [TAG: ci/cd] Fix Container Search Index Baking in Pulse Workflow. [DESC: Resolved OCI runtime path conflict by copying pkd to /usr/local/bin during build and configuring `--source` in pulse.yml. Verified 🟢 PHAROS GREEN.] [ECT: 2] [ACT: 2]
